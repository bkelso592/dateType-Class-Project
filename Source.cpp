...
int main() {
    // Test dateType class here
    dateType date1; // default constructor
    date1.printDate(); // Output: 1-1-1900

    dateType date2(12, 31, 2023); // constructor with parameters
    date2.printDate(); // Output: 12-31-2023

    date2.setMonth(2);
    date2.setDay(29); // Invalid day. No changes made.
    date2.setYear(2024);
    date2.printDate(); // Output: 2-29-2024

    std::cout << "Number of days passed: " << date2.daysPassed() << std::endl;
    std::cout << "Number of days remaining: " << date2.daysRemaining() << std::endl;

    date2.setFutureDate(365);
    date2.printDate(); // Output: 2-28-2025
